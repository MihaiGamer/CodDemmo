...
@Autonomous
public class AutoRedDreapta extends LinearOpMode {
    ...
    // motoare brat
    Servo brat_stanga, brat_dreapta;
    ...
    public void configuratie(){
        ...
        // brat
        brat_stanga = hardwareMap.servo.get("brat_stanga");
        brat_dreapta = hardwareMap.servo.get("brat_dreapta");

        brat_dreapta.setDirection(Servo.Direction.REVERSE);
    ...
    public void brat(int sus_jos){
        if(sus_jos==0 && !brat_sus){
            brat_sus = true;
            brat_jos = false;
        }else if(sus_jos==1 && !brat_jos){
            brat_sus = false;
            brat_jos = true;
        }else{
            brat_sus = false;
