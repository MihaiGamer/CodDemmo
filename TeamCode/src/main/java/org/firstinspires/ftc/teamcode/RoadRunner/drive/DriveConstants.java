...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(-0.05, 0, 1.01, 12.01);
    ...
    public static double kA = 0.00084;
    public static double kStatic = 0.07228;
